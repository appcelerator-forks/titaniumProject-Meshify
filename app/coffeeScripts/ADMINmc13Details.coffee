...
$.vanityName.text = (args.person.last + ", " + args.person.first + " - " + args.node.vanityname)
...
$.vanityName2.text = (args.person.last + ", " + args.person.first + " - " + args.node.vanityname)
...
$.vanityName3.text = (args.person.last + ", " + args.person.first + " - " + args.node.vanityname)
...
$.signal3.text = "-" + args.channels[(deviceName + ".signal")].value + " db"
